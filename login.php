...
<head>
    ...
    <title>Les DZ à Sidi Abdellah - Register</title>
						  ...
						  if(html=='true')
						  {
							...
							window.location.href = "blog.php";
								...
								$("#add_err2").html('<div class="alert alert-danger"> \
													<strong>Authentication</strong> failure. wrong password !\ \
												</div>');


                          } else if (html=='false2') {
							    $("#add_err2").html('<div class="alert alert-danger"> \
												    <strong>Authentication</strong> failure. Email doesnt exist\ \
												</div>');
                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                               <button type="submit" class="btn btn-secondary">  <a href="register.php">Not a member? Register here</a></button>
                            </div>
                        </div>
                    </form>
                </div>
